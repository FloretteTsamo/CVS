...
**Titre recommandé :**
`Élève-Ingénieure RF & Systèmes Embarqués | ENSEA × ENSPY | Cadence Virtuoso · FPGA · Télécoms | Stage dès Mai 2026`

**Résumé recommandé :**
Élève-ingénieure en double diplôme ENSEA (Cergy) et ENSPY (Cameroun), en électronique, RF, systèmes embarqués et télécommunications. Formation pratique avec Cadence Virtuoso (conception NMOS, layout RF, salle blanche ESIEE), FPGA/VHDL, LTspice et traitement du signal (MATLAB, Python). À la recherche d'un stage de 3 à 4 mois à partir de mai 2026 en Île-de-France ou Toulouse, dans le domaine de l'électronique (RF, embarqué, microélectronique, télécoms, puissance).
